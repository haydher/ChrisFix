...
// var channelID = "UCes1EvRjcKU4sY_UEavndBw";
// var id;
...
//   $.getJSON('https://www.googleapis.com/youtube/v3/videos?id=' + id + '&key=AIzaSyCmoMYgQi4ywa2Q00d8l5eK4PPIPc0a03U&part=snippet&callback=?', function (data) {
//     if (typeof (data.items[0]) != "undefined") {
//       $("#videoTitle").text(data.items[0].snippet.title);
//       var description = data.items[0].snippet.description;
//       if (description.length > 255) {
//         description = description.substring(0, 255).trim();
//         description = description + "<a href='https://youtube.com/watch?v=" + id + "'>...</a>";
//       }
